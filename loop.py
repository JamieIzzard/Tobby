...
async def my_background_task():
    ...
    while True:
        ...
        client.send_message(await client.send_message(client.get_channel(channelweb),"!nbj"))
        await asyncio.sleep(20)
        await client.purge_from(client.get_channel(channeltime), limit=10, check=None, before=None, after=None, around=None)
        client.send_message(await client.send_message(client.get_channel(channeltime),"!mp"))
